...
const STEPS: StepItem[] = [
  { label: "Notice how you're feeling", emoji: "🫧" },
  { label: "Pick a gratitude prompt", emoji: "✨" },
  { label: "Write what you appreciate", emoji: "✍️" },
  { label: "See how your mood shifts", emoji: "🌈" },
];
      ...
      <View className="flex-1 justify-center px-2">
        ...
        <View className="items-center mb-6">
          <View className="flex-row items-center bg-slate-100 px-4 py-2 rounded-full">
            ...
            <Text className="text-sm font-bold text-slate-600">4 steps</Text>
          </View>
        </View>

        {/* Steps — Duolingo lesson-preview style */}
