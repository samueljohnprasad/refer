...
import type { DataSourceOption } from "./components/data-source-menu/data-source-menu.types";
...
const AnimatedArrowUpIcon = Animated.createAnimatedComponent(Feather);

export const FluxChartScreen = () => {
  ...
  useEffect(() => {
    iconRotation.value = withTiming(isPositive ? 0 : 180, { duration: 150 });
