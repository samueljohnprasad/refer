...
export const ONBOARDING_STEPS: readonly OnboardingStepConfig[] = [
  ...
  {
    name: "journey_step_preview",
    stage: 4,
    backgroundColor: ONBOARDING_BACKGROUND,
    showBackButton: false,
    showContinueButton: true,
    continueButtonLabel: "START FIRST STEP",
    autoAdvance: false,
    canSkip: false,
    analyticsLabel: "journey_step_preview",
  },
  {
  ...
  {
    name: "cbt_step_preview",
    stage: 5,
    backgroundColor: ONBOARDING_BACKGROUND,
    showBackButton: false,
    showContinueButton: true,
    continueButtonLabel: "SEE MY JOURNEY",
    autoAdvance: false,
    canSkip: false,
    analyticsLabel: "cbt_step_preview",
  },
  {
