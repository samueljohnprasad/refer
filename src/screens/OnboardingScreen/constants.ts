...
const ONBOARDING_BACKGROUND = "#F8FAF7";
...
export const ONBOARDING_STEPS: readonly OnboardingStepConfig[] = [
  ...
  },
  {
    ...
    isContinueEnabled: (formData) => Boolean(formData.stressLevel),
  },
  {
  ...
  },
  {
    ...
    showBackButton: false,
    showContinueButton: true,
    continueButtonLabel: "VIEW MY COURSE",
    autoAdvance: false,
    canSkip: false,
  ...
  },
  {
    ...
    backgroundColor: ONBOARDING_BACKGROUND,
    showBackButton: false,
    showContinueButton: false, // ponytail: no button on journey map
    continueButtonLabel: "START LESSON 1",
    autoAdvance: false,
    canSkip: false,
  ...
  },
  {
    ...
    showBackButton: false,
    showContinueButton: true,
    continueButtonLabel: "Save my progress",
    autoAdvance: false,
    canSkip: true,
...
> = {
  anxiety: {
    question: "How present has anxiety felt lately",
    subtext: "This helps us choose a pace that fits.",
    options: [
      {
        id: "light",
        emoji: "🌤️",
        title: "Background hum",
        subtitle: "It's there, but I can still go about my day.",
      },
      {
        id: "moderate",
        emoji: "🌥️",
      ...
      },
      {
        ...
        emoji: "⛈️",
        title: "Taking over",
        subtitle: "Some days it takes up most of my attention.",
      },
    ],
  },
  mood: {
    ...
    nodes: [
      {
        ...
        subtitle: "Lesson 1 · Mood check-in",
        status: "current",
      },
      {
        id: "2",
        ...
        subtitle: "Lesson 2 · Cognitive distortions",
        status: "locked",
      },
      {
        id: "3",
        ...
        subtitle: "Lesson 3 · Somatic awareness",
        status: "locked",
      },
      {
        id: "4",
        ...
        subtitle: "Lesson 4 · Your first CBT tool",
        status: "locked",
      },
      {
        id: "5",
    ...
    nodes: [
      {
        ...
        subtitle: "Lesson 1 · Emotional clarity",
        status: "current",
      },
      {
        id: "2",
        emoji: "🌤️",
        label: "Tiny Lifts",
        subtitle: "Lesson 2 · Mood anchors",
        status: "locked",
      },
      {
        id: "3",
        emoji: "𫆖",
        label: "Body as Compass",
        subtitle: "Lesson 3 · Somatic check-in",
        status: "locked",
      },
      {
        id: "4",
        ...
        subtitle: "Lesson 4 · Low mood triggers",
        status: "locked",
      },
      {
        id: "5",
        ...
        subtitle: "Lesson 5 · Small actions",
        status: "locked",
      },
      {
        id: "6",
    ...
    nodes: [
      {
        ...
        subtitle: "Lesson 1 · Body stress mapping",
        status: "current",
      },
      {
        id: "2",
        ...
        subtitle: "Lesson 2 · Stress patterns",
        status: "locked",
      },
      {
        id: "3",
        ...
        subtitle: "Lesson 3 · Nervous system reset",
        status: "locked",
      },
      {
        id: "4",
        emoji: "📝",
        label: "Thought Records",
        subtitle: "Lesson 4 · Reframe the load",
        status: "locked",
      },
      {
        id: "5",
        ...
        subtitle: "Lesson 5 · Boundaries & capacity",
        status: "locked",
      },
      {
        id: "6",
    ...
    nodes: [
      {
        ...
        subtitle: "Lesson 1 · Values check-in",
        status: "current",
      },
      {
        id: "2",
        ...
        subtitle: "Lesson 2 · Core beliefs",
        status: "locked",
      },
      {
        id: "3",
        ...
        subtitle: "Lesson 3 · Pattern spotting",
        status: "locked",
      },
      {
        id: "4",
      ...
      },
      {
        ...
        emoji: "🌱",
        label: "Parts of You",
        subtitle: "Lesson 5 · Inner conflict",
        status: "locked",
      },
      {
        id: "6",
    ...
    nodes: [
      {
        ...
        subtitle: "Lesson 1 · Nervous system check-in",
        status: "current",
      },
      {
        id: "2",
        ...
        subtitle: "Lesson 2 · Night-time thought loops",
        status: "locked",
      },
      {
        id: "3",
        emoji: "𫆖",
        label: "Body Scan",
        subtitle: "Lesson 3 · Wind-down cues",
        status: "locked",
      },
      {
        id: "4",
        ...
        subtitle: "Lesson 4 · Brain dump technique",
        status: "locked",
      },
      {
        id: "5",
        emoji: "🌊",
        label: "Riding the Wave",
        subtitle: "Lesson 5 · Acceptance at night",
        status: "locked",
      },
      {
        id: "6",
