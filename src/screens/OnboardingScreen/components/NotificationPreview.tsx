  ...
  return (
    <View className="flex-row items-start gap-2.5 rounded-[14px] border border-sage-100 bg-white/90 px-3.5 py-3">
      ...
      <View className="flex-1">
        <Text className="text-[13px] font-bold text-ink">Happy</Text>
        <Text className="text-xs leading-[1.3] text-ink-soft">
          Hey friend. 5 quiet minutes? Your lesson is ready.
        </Text>
      </View>
      <Text className="text-[11px] text-ink-muted">{time}</Text>
    </View>
  );
};
