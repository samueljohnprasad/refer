...
export default function BottomSheetWithRNContent({ children, isPresented, setIsPresented }: { children: React.ReactNode, isPresented: boolean, setIsPresented: (value: boolean) => void }) {
