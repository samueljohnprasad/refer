...
const MILESTONE_CONFIG: Record<number, MilestoneInfo> = {
    3: { title: '3-Day Streak!', reward: 'You\'re building a habit — keep it up!', emoji: '🔥', confettiCount: 16 },
    7: { title: '7-Day Streak!', reward: 'You earned a Streak Freeze! ❄️', emoji: '🔥', confettiCount: 24 },
    14: { title: '2-Week Streak!', reward: 'Two weeks strong — incredible consistency!', emoji: '🔥', confettiCount: 28 },
    30: { title: '30-Day Streak!', reward: 'A full month! You earned 2 Streak Freezes! ❄️❄️', emoji: '💪', confettiCount: 32 },
    60: { title: '60-Day Streak!', reward: 'Two months of daily growth — remarkable!', emoji: '⭐', confettiCount: 36 },
    100: { title: '100-Day Streak!', reward: 'Triple digits! You earned the Century Badge! 🏅', emoji: '🏆', confettiCount: 40 },
    365: { title: '365-Day Streak!', reward: 'One full year — you\'re truly extraordinary! 🌟', emoji: '👑', confettiCount: 50 },
};
...
function MilestoneBadge({ days, emoji }: { days: number; emoji: string }): React.JSX.Element {
        ...
        <Modal visible={visible} animationType="fade" transparent={false} onRequestClose={onDismiss}>
            <SafeAreaView className="flex-1 bg-white" edges={['top', 'bottom']}>
                ...
                <View className="px-5 pb-4 pt-2">
                    ...
                    >
                        <Text className="text-base font-bold text-white">Keep it going! 🔥</Text>
                    </PressableScale>
                </View>
            </SafeAreaView>
        </Modal>
