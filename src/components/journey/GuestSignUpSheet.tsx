      ...
      <>
        ...
        >
          <View className="flex-1 px-6 pt-5 pb-8">
            ...
            <Text className="text-gray-500 text-[15px] leading-6 mb-5">
              You've completed{' '}
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              className="w-full bg-gray-900 rounded-full h-14 items-center justify-center mb-3"
            ...
            >
              <Text className="text-gray-400 text-sm font-medium">Not Now</Text>
            </TouchableOpacity>
          </View>
        </ShortBottomModal>
