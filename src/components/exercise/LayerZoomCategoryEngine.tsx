...
const styles = StyleSheet.create({
  ...
  layerMiddle: { borderColor: COURSE_EXERCISE_COLORS.oliveLight, backgroundColor: COURSE_EXERCISE_COLORS.oliveTint },
  layerInner: { borderColor: COURSE_EXERCISE_COLORS.olive, backgroundColor: COURSE_EXERCISE_COLORS.oliveLight },
  ...
  kickerOlive: { color: COURSE_EXERCISE_COLORS.oliveDark },
