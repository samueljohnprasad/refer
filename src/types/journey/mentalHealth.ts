...
export type ExerciseInputType = 'text' | 'slider' | 'picker' | 'multi_choice' | 'rating';
...
export interface AIInsightContent {
    ...
    analysis_types: ('mood_arc' | 'journal_themes' | 'thought_patterns' | 'technique_effectiveness')[];
...
export const STREAK_MILESTONES: readonly number[] = [3, 7, 14, 30, 60, 100, 365] as const;
