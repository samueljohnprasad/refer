...
export interface HeaderOverlayContentViewProps
  extends ReturnType<typeof useHeaderOverlayContentViewModel> {
 ...
 */
export const HeaderOverlayContentView = React.memo(function HeaderOverlayContentView({
  width,
  animatedStyle,
  courses,
  activeCourseId,
 ...
 */
const HeaderOverlayContent = (props: HeaderOverlayContentProps): React.JSX.Element => {
