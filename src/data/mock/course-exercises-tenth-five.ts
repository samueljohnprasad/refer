...
export const TENTH_FIVE_COURSE_EXERCISES: Exercise[] = [
  {
    ...
    content: {
      ...
      instruction:
        "One concept, discovered through your own night. Scripted branches — never scored, never diagnostic.",
      supportTitle: "You matter more than any lesson.",
      supportBody:
        "In production this card renders verified, region-checked support options — crisis lines, text lines, and a warm handoff — audited on a schedule. Wrong numbers are a launch blocker here.",
      terminalNote:
        "This conversation adapted to your answer — that’s the format. Scripted branches only; never diagnostic.",
      nodes: {
        start: {
          message:
        ...
        land: {
          ...
          supportive: true,
          message:
            "Park it: one line per worry in a notebook by the bed, each with a slot tomorrow — then the bed goes back to being boring. You just discovered worry parking — through your own 2am, which is why it’ll stick.",
        },
        guard: {
          supportive: true,
          message:
  ...
  },
  {
    ...
    content: {
      ...
      insight:
        "Same three lines you read cold at the start. Now every phrase has a name and a shape — that’s what this unit installed.",
