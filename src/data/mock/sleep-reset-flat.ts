  ...
  nodes: [
    {
      ...
      orderIndex: 0,
      estimatedMins: 4,
      newConcepts: ["sleep_pressure", "body_clock", "arousal"],
      reviewConcepts: [],
      prerequisites: [],
    },
    {
  ...
  exercises: [
    {
      ...
      content: {
        ...
        maxAttempts: 3,
        workedExample:
          "Early sleep has more deep sleep. Later sleep has more dream sleep.",
        support: {
        ...
        feedback_correct:
          "Yes. Early sleep is mostly deep sleep, and late sleep is mostly dream sleep.",
        feedback_incorrect:
          "Try the simple order: early sleep first, late sleep second.",
      },
    },
    {
      id: "l1_e1b",
      ...
      content: {
        ...
        prompt:
          "You wake at 4am after a vivid dream. What is the best explanation?",
        situationOptions: [
          {
            id: "rem",
        ...
        maxAttempts: 3,
        workedExample:
          "If the waking is near morning and dream-like, the useful clue is REM. REM gets longer later in sleep.",
        support: {
          clue: "Morning dreams usually point to REM sleep.",
          easier: "Choose the answer that says late sleep has more REM.",
          workedAnswer:
            "Situation: late sleep has more REM. Reason: REM sleep gets longer later in the night.",
        },
        feedback_correct:
          "Right. Vivid dreams near morning usually fit normal late-night REM.",
        feedback_incorrect:
          "Not quite. Late sleep has more REM, so dream-like waking can be normal.",
      },
    },
    {
      id: "l1_e2",
      ...
      content: {
        ...
        maxAttempts: 3,
        workedExample:
          "Deep sleep is the better match for body repair. REM is closer to dreaming.",
        support: {
          clue: "REM is mostly linked with dreams.",
          easier: "Body repair belongs with deep sleep.",
          workedAnswer:
            "Deep sleep is the body-repair answer. REM is the dream-sleep distractor.",
        },
        feedback_correct: "Yes. Deep sleep is the body-repair stage.",
        feedback_incorrect:
          "REM is more connected to dreams. Deep sleep is more connected to body repair.",
      },
    },
    {
      id: "l2_e1",
      ...
      content: {
        ...
        feedback_correct:
          "Right. Remember: early night = N3 heavy, late night = REM heavy.",
        feedback_incorrect:
          "Not quite. Early sleep is N3-heavy (deep). Late sleep is REM-heavy (dreams).",
      },
    },
    {
      id: "l2_e2",
    ...
    },
    {
      ...
      content: {
        statement:
          "The first sleep cycle of the night is typically the longest.",
        correct: false,
        explanation:
          "Actually, the first cycle is usually the shortest (70-100 mins). Later cycles get longer!",
      },
    },
    {
      id: "l2_e3",
      ...
      content: {
        prompt:
          "Put these events in the order they happen during a typical night:",
        items: [
          {
            id: 0,
    ...
    },
    {
      ...
      content: {
        statement:
          "If you wake at 3am and can't fall back asleep, it's because you're broken or sick.",
        correct: false,
        explanation:
          "False. At 3am you're in a late-cycle REM sleep — dream mode. Waking then is completely normal if something disrupts you (sound, temperature, need to use bathroom). Your sleep isn't broken; you're just in a different brain state than at 11pm.",
      },
    },
    {
      id: "l2_e4b",
      ...
      content: {
        prompt:
          "How many sleep cycles does a typical person go through in a full night?",
        options: [
        ...
        feedback_correct:
          "Correct! Each cycle is roughly 90-120 minutes, adding up to a full night.",
        feedback_incorrect:
          "Not quite. Think about 90 minute chunks over 7-8 hours (4-5 cycles).",
      },
    },
    {
      id: "l2_e5",
      ...
      content: {
        prompt:
          "Describe a time you woke at 3-5am. What time did you fall asleep? What time did you wake? Now you know: that's your sleep cycles happening exactly as they should.",
        sub_prompts: [
        ...
        mood_before: true,
        mood_after: true,
        tags: ["sleep_cycles", "3am_waking", "normalization"],
      },
    },
    {
      id: "l2_e5b",
      ...
      content: {
        statement:
          "It is completely abnormal to briefly wake up between sleep cycles.",
        correct: false,
        explanation:
          "Brief awakenings between cycles are 100% normal and biological. Most people just forget them!",
      },
    },
    {
      id: "l2_e6",
      ...
      content: {
        prompt:
          "A typical first sleep cycle lasts about ___ minutes. Later cycles last about ___ minutes.",
        options: [
          {
            id: "a",
        ...
        feedback_correct:
          "Exactly. First cycle is shorter (70-100), later cycles lengthen (90-120).",
        feedback_incorrect:
          "Close but not quite. First cycles are 70-100 min. Later cycles stretch to 90-120 min.",
      },
    },
    {
      id: "l2_e6b",
      ...
      content: {
        ...
        template:
          "Later sleep cycles have much more {1} sleep, which is why we remember {2} right before waking.",
        options: [
        ...
        feedback_incorrect:
          "Remember, the end of the night is packed with REM (dream) sleep.",
      },
    },
    {
      id: "l2_e7",
      ...
      content: {
        prompt:
          "How much sense does the 'sleep cycles explain 3am waking' idea make to you now?",
        min: 1,
        max: 5,
        labels: [
          "No sense yet",
    ...
    },
    {
      ...
      content: {
        prompt:
          "Review: Which sleep stage happens mostly in the later half of the night (like 4am)?",
        options: [
          {
            id: "a",
            text: "REM (dream sleep)",
        ...
        feedback_correct:
          "Right! Later sleep cycles are longer and packed with REM (dream) sleep.",
        feedback_incorrect:
          "Not quite. Deep sleep (N3) happens early. The later half of the night is mostly REM (dreams).",
      },
    },
    {
      id: "l3_e2",
    ...
    },
    {
      ...
      content: {
        statement:
          "Your circadian rhythm only operates when it's dark outside.",
        correct: false,
        explanation:
          "False! It's a 24-hour internal clock that runs continuously, controlling alertness during the day too.",
      },
    },
    {
      id: "l3_e3",
      ...
      content: {
        scenario:
          "You sleep 7am Mon-Fri, 10am Sat-Sun. Your clock gets confused. You're groggy, sleep is patchy.",
        ...
        options: [
          {
            ...
            correct: true,
            feedback:
              "Exactly. Your clock needs a consistent anchor. Even 2-3 hour shifts on weekends can disrupt the whole week.",
          },
          {
            id: "b",
            ...
            correct: false,
            feedback:
              "Sleep amount isn't the issue. Your TIMING (wake time) is inconsistent, so your clock stays confused.",
          },
          {
            id: "c",
            ...
            correct: false,
            feedback:
              "Actually, weekend drift makes things worse. Consistency is what your clock needs.",
          },
        ],
      },
    },
    {
      ...
      content: {
        ...
        pairs: [
          {
            left: "Consistent Morning Wake Time",
            right: "Anchors the 24-hr clock",
          },
          {
            left: "Sleeping in 3 hours on Sunday",
            right: "Drifts the clock and causes grogginess",
          },
        ],
      },
    },
    {
      ...
      content: {
        prompt:
          "What time do you wake on weekdays vs weekends? How consistent is your wake time?",
        sub_prompts: [
    ...
    },
    {
      ...
      content: {
        statement:
          "Sleeping in on weekends is a great way to catch up on sleep without confusing your body.",
        correct: false,
        explanation:
          "Actually, sleeping in shifts your 'wake anchor', confusing your clock and making Monday morning miserable.",
      },
    },
    {
      id: "l3_e5",
      ...
      content: {
        ...
        feedback_correct:
          "Right. Wake time is the master anchor. Bedtime naturally follows when the clock is set correctly.",
      },
    },
    {
      id: "l3_e5b",
      ...
      content: {
        ...
        options: [
          {
            id: "a",
            text: "Right after the wake maintenance zone (bedtime)",
            correct: true,
          },
        ...
        feedback_correct:
          "Right! Your clock spikes alertness right before bed, then drops it sharply so you can sleep.",
        feedback_incorrect:
          "Not quite. The sharpest drop happens right around bedtime.",
      },
    },
    {
      id: "l3_e5c",
      ...
      content: {
        ...
        feedback_incorrect:
          "Remember, WAKE TIME is the anchor, and weekends are usually when we mess it up!",
      },
    },
    {
      id: "l3_e6",
      ...
      content: {
        prompt:
          "Does this 'circadian clock' idea change how you think about your sleep schedule?",
        scale: 5,
        labels: [
          "Not at all",
          "Slightly",
    ...
    },
    {
      ...
      content: {
        prompt:
          "Sleep cycles get longer as the night goes on. First cycle is 70-100 min; later cycles are ___?",
        options: [
          {
            id: "a",
            text: "90-120 minutes",
        ...
        feedback_correct:
          "Right. Cycles lengthen. That's why late-night sleep feels different.",
      },
    },
    {
      id: "l4_e2",
    ...
    },
    {
      ...
      content: {
        prompt:
          "Does this explain why your 3am waking feels SO different from your 7am waking?",
        scale: 5,
        labels: [
          "Not really",
          "A bit",
    ...
    },
    {
      ...
      content: {
        prompt:
          "Adenosine (sleep pressure) builds up all day like a tank filling. By 11pm, the tank is full AND your circadian alert has dropped. This means:",
        options: [
          {
            id: "a",
    ...
    },
    {
      ...
      content: {
        scenario:
          "You take a 2-hour nap at 4pm. Your adenosine tank drains. At 11pm, even though your clock alert is dropping, your pressure tank is still only half-full. You can't fall asleep.",
        question: "Why?",
        options: [
          {
            id: "a",
            ...
            correct: true,
            feedback:
              "Yes. Naps drain pressure. The longer the nap, the less pressure by bedtime. This is why late-afternoon naps wreck night sleep.",
          },
          {
            id: "b",
            ...
            correct: false,
            feedback:
              "Not anxiety. Your adenosine pressure is literally too low. The two-process system is balanced wrong.",
          },
          {
            id: "c",
            ...
            correct: false,
            feedback:
              "Your body didn't reject it. The nap lowered your sleep pressure, so bedtime feels less urgent.",
          },
        ],
      },
    },
    {
      ...
      content: {
        prompt:
          "Do you nap? If so, what time, and how does it affect your night sleep? How could you adjust your nap to protect night sleep?",
        min_words: 15,
        max_words: 120,
      },
    },
    {
      ...
      content: {
        ...
        feedback_correct:
          "Right. Late naps drain pressure when you need it at bedtime.",
      },
    },
    {
      id: "l5_e6",
      ...
      content: {
        prompt:
          "Does the 'adenosine tank' model make sense for why you sometimes can't sleep at bedtime?",
        scale: 5,
        labels: [
          "Not at all",
          "A little",
    ...
    },
    {
      ...
      content: {
        prompt:
          "Adenosine is what your brain 'feels' as sleepiness. What blocks adenosine receptors?",
        options: [
          {
            id: "a",
        ...
        feedback_correct:
          "Right. Caffeine is the blocker. So even when pressure is high, caffeine prevents your brain from FEELING it.",
      },
    },
    {
      id: "l6_e2",
    ...
    },
    {
      ...
      content: {
        statement:
          "If you take 200mg caffeine at 2pm, it's mostly gone by 8pm, so it won't affect your 11pm sleep.",
        correct: false,
        explanation:
          "False. Half-life of 5-6 hours means 50mg is still in your system at 8pm, and 25mg at 11pm. That's enough to block adenosine and disrupt sleep. Plus, genetic variation means some people metabolize it much slower.",
      },
    },
    {
      id: "l6_e4",
    ...
    },
    {
      ...
      content: {
        ...
        feedback_correct:
          "Right. 2pm cutoff is a safe rule for most people (though genetics vary).",
      },
    },
    {
      id: "l6_e6",
      ...
      content: {
        prompt:
          "Does this explain your nighttime wakefulness after afternoon coffee?",
        scale: 5,
        labels: [
          "Not at all",
          "Slightly",
    ...
    },
    {
      ...
      content: {
        ...
        feedback_correct:
          "Right. Late cycles are REM-heavy. This is important for understanding alcohol's effect.",
      },
    },
    {
      id: "l7_e2",
    ...
    },
    {
      ...
      content: {
        scenario:
          "You have two glasses of wine at 7pm. You fall asleep easily at 10pm (alcohol helped). But at 2am you wake fragmented, sweating, heart racing, can't get back to sleep.",
        ...
        options: [
          {
            ...
            correct: true,
            feedback:
              "Yes. Alcohol helps onset but destroys second-half sleep. The crash at 2am is classic REM rebound.",
          },
          {
            id: "b",
            ...
            correct: false,
            feedback:
              "Not just sensitivity — this is a dose-dependent effect everyone experiences.",
          },
          {
            id: "c",
            ...
            correct: false,
            feedback:
              "Timing doesn't fix it. The alcohol will metabolize 4-5 hrs post-dose, disrupting late sleep regardless.",
          },
        ],
      },
    },
    ...
    },
    {
      ...
      content: {
        ...
        feedback_correct:
          "Right. DOSE matters. There's no universal safe amount; lower is always better for sleep.",
      },
    },
    {
      id: "l7_e6",
      ...
      content: {
        prompt:
          "Does this explain your fragmented, sweaty sleep after drinking alcohol?",
        scale: 5,
        labels: [
          "Not at all",
          "Slightly",
    ...
    },
    {
      ...
      content: {
        scenario:
          "Monday-Friday you wake at 7am, feel okay. Saturday you sleep until 10am. Sunday the same. Monday you wake groggy at 7am. Sleep that night is patchy.",
        ...
        options: [
          {
            ...
            correct: true,
            feedback:
              "Exactly. Consistency matters more than duration. One or two 'catch-up sleep' days reset your whole week.",
          },
          {
            id: "b",
            text: "You just need more sleep",
            correct: false,
            feedback:
              "Sleep amount isn't the issue. It's TIMING. Your clock is confused.",
          },
          {
            id: "c",
            ...
            correct: false,
            feedback:
              "If this happens every Monday after weekends, it's your clock, not fatigue.",
          },
        ],
      },
    },
    {
      ...
      content: {
        prompt:
          "Do you have irregular wake times (different weekday vs weekend)? If so, what's the drift? How could you make it more consistent?",
        min_words: 15,
        max_words: 120,
      },
    },
    {
      ...
      content: {
        prompt:
          "Of these three disruptors (light, stress, irregular wake), which ones apply to you?",
        scale: 4,
        labels: ["None", "One", "Two", "All three"],
        note_enabled: false,
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        prompt:
          "Personal disruptor audit: Identify your own TOP 3 disruptors from this section. For each, explain WHAT it is and WHY it disrupts your sleep.",
        sub_prompts: [
    ...
    },
    {
      ...
      content: {
        prompt:
          "Which ONE of your top 3 disruptors could you change FIRST? Why start with that one?",
        min_words: 10,
        max_words: 100,
      },
    },
    {
      ...
      content: {
        prompt:
          "Now that you understand your sleep disruptors, how do you feel?",
        scale: 5,
        labels: ["Overwhelmed", "Uncertain", "Neutral", "Hopeful", "Empowered"],
        note_enabled: true,
      },
    },
  ],
