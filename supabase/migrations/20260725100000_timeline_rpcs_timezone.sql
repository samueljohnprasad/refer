-- Migration: Timeline RPCs Timezone Support // ponytail: accurate local dates using user_preferences timezone
-- Date: 2026-07-25
-- Description: Updates timeline pagination RPCs to extract calendar dates, weeks, and months in user's local timezone
