...
INSERT INTO reward_units VALUES
  ...
  ('u1_2_sleep_disruptors', 'You can now spot what may be disrupting your sleep — and choose one small thing to test.', 'Small inputs can shift the system', 'Caffeine, alcohol, light, and stress affect different parts of sleep. Testing one change makes the result easier to read.'),
