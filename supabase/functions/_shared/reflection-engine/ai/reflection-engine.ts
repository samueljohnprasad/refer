...
export class ReflectionEngine {
  ...
  public async generateDailyReflection(context: DailyContext): Promise<DailyReflectionResult> {
  ...
  public async generateWeeklyReflection(context: WeeklyContext): Promise<WeeklyReflectionResult> {
  ...
  public async generateMonthlyReflection(context: MonthlyContext): Promise<MonthlyReflectionResult> {
