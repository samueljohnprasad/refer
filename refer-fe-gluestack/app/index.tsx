  ...
  return (
    <Box className="w-full h-full">
      <Box className="lg:w-[1200px] w-full min-h-screen mx-auto flex font-body flex-row  ">
        ...
        <Box className="w-full lg:pl-[212px]  border-primaryBorder flex flex-row">
          <Box className="lg:w-[640px] w-full h-full  pt-14 pb-20 lg:border-r lg:border-l box-border">
            <Box className="h-14 z-60  border-b border-primaryBorder box-border lg:max-w-[640px] lg:w-[640px] fixed top-0 bg-gray-00 py-4  sm:px-6 lg:left-auto lg:right-auto flex items-center hidden lg:flex justify-center left-12 right-12 px-2"></Box>
          ...
          <Box>
            <Box className="lg:w-[349px] flex h-14 top-0 w-full relative z-50 ">
              {/* <Box className="lg:w-[349px] h-14 z-10 border-b -mt-px fixed top-0 bg-gray-00 lg:px-6 flex-shrink-0 lg:border-b border-primaryBorder"></Box> */}
            </Box>
