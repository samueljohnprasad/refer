...
const mockLifeDomainData = [
  {
    ...
    insights: "Steady progress in current projects",
  },
  {
    ...
    attention_needed: false,
    insights: "Strong connections with close friends",
  },
  {
    domain: "Health",
    score: 40,
    ...
    insights: "Sleep schedule has been erratic",
  },
  {
    ...
    trend: "improving" as const,
    attention_needed: false,
    insights: "Reading habit is paying off",
  },
  {
    domain: "Recreation",
    score: 50,
    trend: "stable" as const,
    attention_needed: false,
    insights: "Need more time for hobbies",
  },
  {
    domain: "Spirituality",
    score: 60,
    trend: "stable" as const,
    attention_needed: false,
    insights: "Consistent meditation practice",
  },
];
...
export default function TestChartsScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F9FAFB" }}>
      <Stack.Screen
        options={{ title: "Test Charts & UI", headerBackTitle: "Back" }}
      />
      <ScrollView
      ...
      >
        <TouchableOpacity
          onPress={(e) =>
            navigateWithReveal(e, "/tabs/screens/reveal-destination", "#4ECDC4")
          }
          style={{
            padding: 16,
        ...
        <Text variant="h2" className="mb-4 mt-2 text-gray-800">
          Flux Chart
        </Text>
        <View
          style={{
