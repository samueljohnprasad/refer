/*
SettingsScreen.js
React Native (Expo) single-file screen with UI/UX enhancements:

Enhancements:
1. Removed background gradient layer.
2. List design simplified as shown in reference (flat list style).
3. Removed shadows from cards/surface.
4. Added colorful circular icons.
5. Back button updated to circular purple style.
6. Upgrade button enhanced with gradient fill and ripple feedback.
7. Added haptic feedback to row presses and toggle switches.
8. Added 'Feedback / Rate Us' option and 'App Info' section.
